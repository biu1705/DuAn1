...
document.getElementById('cartForm').addEventListener('submit', function(e) {
    ...
    // Tạo đối tượng FormData mới từ form
    const formData = new FormData(this);
    
    // Đảm bảo có trường update_cart
    formData.append('update_cart', '1');
    
    // Hiển thị thông báo đang cập nhật
    showMessage('Đang cập nhật giỏ hàng...', true);
    ...
    .then(data => {
        ...
        // Nếu cập nhật thành công, cập nhật UI mà không reload trang
        if (data.success) {
            // Tạm thời vẫn reload trang để đảm bảo đồng bộ
            setTimeout(() => {
                window.location.reload();
            }, 1000);
        }
